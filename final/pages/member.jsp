...
<html lang="en">
	...
	<body>
		...
		<%
			...
			{
				response.setHeader("refresh","0;URL=userdetail.jsp") ;
			}
		%>
		<div class = "main-content" id="main">
			<div class="log">
				<img src="../assets/images/logo.png" class="logpic">
				<br>
				<div class="pla">
					<button class="bt"  onclick="location.href='login.html'"><span>登入</span></a></button>
					<button class="bt bt2"  onclick="location.href='register.html'"><span>加入我們</span></a></button>
				</div>
			</div>
