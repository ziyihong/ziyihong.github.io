		...
		<div class = "main-content" id="main">
			<div class="table">
				<form action="createAccount.jsp" method="post">
					...
					<div class="table2">
						<span>密碼</span><br>
						<input type="password" name="password1" size="30" required  onkeyup="value=value.replace(/[\W]/g,'') " onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" ID="Text1" NAME="Text1" onclick="javascript:clearmsg();" onchange="javascript:registCheck();">
					</div>
					<div class="table2">
						<span>確認密碼</span><br>
						<input type="password" name="password2" size="30" required  onkeyup="value=value.replace(/[\W]/g,'') " onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" ID="Text1" NAME="Text1">
					</div>
					
					<div class="table2">
						<span>手機號碼</span><br>
						<input type="text" name="phone" size="30" onclick="javascript:clearmsg();"/>
					</div>
					<div class="enter">
						
						<button class="bt" type="submit"><span>創建</span></a></button>
					</div>
					<%
